...
##
## DISABLED: These tests cause SIGSEGV when run after Ward tests in the combined suite.
## They pass when run in isolation, suggesting a test framework or state isolation issue.
## TODO: Investigate and fix the root cause of the segfault in the combined test runner.

import balls
import ../../loony

when false:  # Disabled due to SIGSEGV in combined test runner
  type
