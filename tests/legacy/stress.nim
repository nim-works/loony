## Legacy Stress Tests - CPS/Continuation based
## These tests validate the queue with Nim's Continuation type under stress
...
suite "loony legacy - continuation stress":
  block:
